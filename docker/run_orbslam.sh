...
gnome-terminal -t "carla-ros" -- bash -c "docker run -it --rm --name=carla-ros --network=host -e DISPLAY --runtime=nvidia harbor.isus.tech/carla-ros/carla-ros:0.9.10.1-noetic bash /carla_ego.sh"

sleep 2

echo "start carla-orb..."
gnome-terminal -t "carla-orb" -- bash -c "docker run -it --rm --name=carla-orb --network=host -e DISPLAY --runtime=nvidia harbor.isus.tech/carla-ros/orbslam3"
