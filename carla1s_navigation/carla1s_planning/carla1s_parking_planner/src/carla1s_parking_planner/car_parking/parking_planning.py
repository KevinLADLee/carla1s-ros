...
from vertical_parking import VerticalParking
from env import Env
...
class Planning():
    def __init__(self,env):
        ...
        # 设置坐标转换函数
        self.space_change = SpaceChange([self.env.parking_left_front_point_x, self.env.parking_left_front_point_y],
    ...
    def reset_env(self,env):
        ...
        # 设置垂直停车算法
        self.__parking_algorithm = VerticalParking(sim_env)
