...
from carla1s_msgs.msg import PathTrackingAction, PathTrackingActionGoal, PathTrackingActionResult,PathTrackingResult,PathTrackingGoal
...
def main(args=None):
    ...
    try:
        carla1s_parking_planner = VerticalParkingTrackingNode()
        rospy.spin()
