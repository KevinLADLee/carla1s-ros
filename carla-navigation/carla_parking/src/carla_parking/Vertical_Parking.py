...
# #绘制一辆车
# def draw_car(x,y,theta,car_w,car_l,wheel_dis):
#
#     whx1=x-math.sin(theta)*car_w/2
#     whx2=x+math.sin(theta)*car_w/2
#     why1=y+math.cos(theta)*car_w/2
#     why2=y-math.cos(theta)*car_w/2
#
#     #车后轮的轴线
#     x1 = [whx1,  whx2]
#     y1 = [why1, why2]
...
#     #车边框
#     #车左边框
#     x1 = [whx1-(car_l-wheel_dis)*math.cos(theta)/2,
#           whx1+(car_l+wheel_dis)*math.cos(theta)/2]
#     y1 = [why1-(car_l-wheel_dis)*math.sin(theta)/2,
#           why1+(car_l+wheel_dis)*math.sin(theta)/2]
#     plt.plot(x1, y1, 'black')
#     #车右边框
#     x1 = [whx2-(car_l-wheel_dis)*math.cos(theta)/2,
#           whx2+(car_l+wheel_dis)*math.cos(theta)/2]
#     y1 = [why2-(car_l-wheel_dis)*math.sin(theta)/2,
#           why2+(car_l+wheel_dis)*math.sin(theta)/2]
#     plt.plot(x1, y1, 'black')
#     # 车尾边框
#     x1 = [whx1-(car_l-wheel_dis)*math.cos(theta)/2,
#           whx2-(car_l-wheel_dis)*math.cos(theta)/2]
