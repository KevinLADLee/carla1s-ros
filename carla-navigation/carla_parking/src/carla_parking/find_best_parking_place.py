...
from simulate_car_model import car_model
import math
from Space_Change import S_change

class get_best_place():
    def __init__(self, cl=None, cw=None, min_r=None, wl=None,
        ...
        # 设置坐标转换函数
        self.space_change = S_change([self.__lp[0], self.__lp[1]],
    ...
    def __angle_init_turn(self,x, y, theta):
        ...
        cos_theta_r2p = (y2 - road_w + self.__r_add_front) / (2 * self.__min_turning_radiu)
        theta_r2p = math.acos(cos_theta_r2p)
        return theta_r2p
    ...
    def get_best_place(self,show=False):
        ...
        car_x,car_y,car_theta=self.__get_car_position_from_left_head(x2,road_w,road_turn_max_r)
...
if __name__ == "__main__":
    ...
    #初始化寻找最优停车位方法
    get_park=get_best_place(car_l,car_w,min_turning_radiu,wheel_dis,hou_xuan,road_w,real_parking_left_head,real_parking_right_head)
